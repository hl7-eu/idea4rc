...
* group[=].element[+].code = #SurgeryI4rc.intention					
* group[=].element[=].display = "Surgery intention"					
* group[=].element[=].target.code = #Procedure.extension:ProcedureCategoryR5					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
* group[=].element[=].target.comment = "Managed as a procedure categorym to be further analyzed"					
* group[=].element[+].code = #SurgeryI4rc.typeOfApproach					
...
* group[=].element[+].code = #SurgeryI4rc.marginsAfterSurgery					
...
* group[=].element[+].code = #SurgeryI4rc.tumorRupture					
...
* group[=].element[+].code = #SurgeryI4rc.SpecimenMitoticCount					
...
* group[=].element[+].code = #SurgeryI4rc.SpecimenGradingOnlyInUntreatedTumours					
...
* group[=].element[+].code = #SurgeryI4rc.isolatedLimbPerfusion					
* group[=].element[=].display = "Isolated Limb perfusion"					
* group[=].element[=].target.code = #Procedure.					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
* group[=].element[=].target.comment = "TBD"					
* group[=].element[+].code = #SurgeryI4rc.reconstruction					
* group[=].element[=].display = "Reconstruction"					
* group[=].element[=].target.code = #Procedure.					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #relatedto					
* group[=].element[=].target.comment = "TBD"					
* group[=].element[+].code = #SurgeryI4rc.neckSurgery					
...
* group[=].element[+].code = #SurgeryI4rc.dateOfNeckSurgey					
...
* group[=].element[+].code = #SurgeryI4rc.lateralityOfTheDissection					
...
* group[=].element[+].code = #SurgeryI4rc.surgeryOnM					
