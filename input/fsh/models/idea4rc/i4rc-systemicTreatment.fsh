...
* treatmentResponseBasedOnImagingAloneNoRecistOrOtherCriteria 1..1 CodeableConcept "Treatment response (based on imaging alone; no recist or other criteria)" """Measures how well a cancer patient responds to treatment. RECIST criteria should not be applied. The definition of Complete response; Partial response; Stable disease; Progression, should be based on the clinical judgement based on imaging.  Only when setting=neoadiuvant or  palliative"""		
//--- END		
//--- END		
//--- END		
...
Death - 4306655
Unknown - 4129922"""		
* treatmentResponseBasedOnImagingAloneNoRecistOrOtherCriteria ^comment = """Complete response; Partial response; Stable disease; Progression; Unknown.
