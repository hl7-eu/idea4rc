...
"""				
* tumorGroup.smoothMuscleTumours 1..1 CodeableConcept "Smooth muscle tumours" """Smooth muscle tumours"""				
* tumorGroup.skeletalMuscleTumours 1..1 CodeableConcept "Skeletal muscle tumours" """Skeletal muscle tumours"""				
* tumorGroup.chondroOsseousTumours 1..1 CodeableConcept "Chondro-osseous tumours
" """Chondro-osseous tumours
"""				
* tumorGroup.peripheralNerveSheathTumours 1..1 CodeableConcept "Peripheral nerve sheath tumours" """Peripheral nerve sheath tumours"""				
* tumorGroup.tumoursOfUncertainDifferentiation 1..1 CodeableConcept "Tumours of uncertain differentiation" """Tumours of uncertain differentiation"""				
* tumorGroup.undifSmallRCelSarcBonAndSofTis 1..1 CodeableConcept "Undifferentiated small round cell sarcomas of bone and soft tissue" """Undifferentiated small round cell sarcomas of bone and soft tissue"""				
* tumorGroup.endStrAndRelatedTumours 1..1 CodeableConcept "Endometrial stromal and related tumours" """Endometrial stromal and related tumours"""				
* tumorGroup.miscellaniousMesenchimalTumors 1..1 CodeableConcept "Miscellanious mesenchimal tumors" """Miscellanious mesenchimal tumors"""				
* tumorGroup.mixedEpithelialAndMesenchymalTumours 1..1 CodeableConcept "Mixed epithelial and mesenchymal tumours" """Mixed epithelial and mesenchymal tumours"""				
* subsites 1..1 BackboneElement "" """"""				
* subsites.nasalCavityAndParanasalSinusesSubsite 1..1 CodeableConcept "Nasal cavity and paranasal sinuses subsite" """Specifies the subsite for cancers occurred in nasal cavity and paranasal sinusess"""				
* subsites.nasopharynxSubsite 1..1 CodeableConcept "Nasopharynx  subsite" """Specifies the subsite for cancers occurred in nasopharynx"""				
* subsites.hypopharynxSubsite 1..1 CodeableConcept "Hypopharynx subsite" """Specifies the subsite for cancers occurred in hypopharynx"""				
* subsites.oropharynxSubsite 1..1 CodeableConcept "Oropharynx subsite" """Specifies the subsite for cancers occurred in oropharynx"""				
* subsites.larynxSubsite 1..1 CodeableConcept "Larynx subsite" """Specifies the subsite for cancers occurred in larynx"""				
* subsites.oralCavitySubsite 1..1 CodeableConcept "Oral cavity subsite" """Specifies the subsite for cancers occurred in oral cavity"""				
* subsites.lipSubsite 1..1 CodeableConcept "Lip subsite" """Specifies the subsite for cancers occurred in lip"""				
* subsites.upperAndLowerLimbsSubsite 1..1 CodeableConcept "Upper and Lower limbs subsite" """Specifies the subsite for cancers occurred in"""				
...
* subsites.breastSubsite 1..1 CodeableConcept "Breast subsite" """Specifies the subsite for cancers occurred in"""				
* subsites.otherSubsite 1..1 CodeableConcept "Other subsite" """Specifies the subsite for cancers occurred in"""				
...
Grade-H - 1635587
Grade-L - 1634085"""				
* histologySubGroup ^comment = """Added to the model for grouping elements"""				
...
* histologySubGroup.histologyNeuroendocrine ^comment = """Small cell neuroendocrine�carcinoma (SmCC)?,Poorly differentiated neuroendocrine carcinoma, small cell (grade 3);Large cell neuroendocrine carcinoma (LCNEC)?, Poorly differentiated neuroendocrine carcinoma, large cell (grade 3);Well-differentiated neuroendocrine carcinoma, Middle ear carcinoid tumor;Moderately differentiated neuroendocrine carcinoma
...
"""				
* tumorGroup.pericyticPerivascularTumours ^comment = """Glomus tumour NOS

Glomus tumour - 40571984
"""				
* tumorGroup.smoothMuscleTumours ^comment = """Smooth muscle tumour of uncertain malignant potential
...
Metastasizing leiomyoma - 4029023
"""				
* tumorGroup.skeletalMuscleTumours ^comment = """Embryonal rhabdomyosarcoma NOS
...
"""				
* tumorGroup.chondroOsseousTumours ^comment = """Extraskeletal osteosarcoma

Extraskeletal osteosarcoma - 4298240
"""				
* tumorGroup.peripheralNerveSheathTumours ^comment = """Malignant peripheral nerve sheath tumour NOS
...
"""				
* tumorGroup.tumoursOfUncertainDifferentiation ^comment = """Atypical fibroxanthoma
...
"""				
* tumorGroup.miscellaniousMesenchimalTumors ^comment = """Uterine tumour resembling ovarian sex cord tumour
...
"""				
* tumorGroup.mixedEpithelialAndMesenchymalTumours ^comment = """Adenosarcoma; please clarify if adenosarcoma with sarcomatous overgrowth

Adenosarcoma - 4135215"""				
				
* subsites.nasalCavityAndParanasalSinusesSubsite ^comment = """AJCC 8th Edition Cancer Staging Manual
...
* subsites.nasopharynxSubsite ^comment = """AJCC 8th Edition Cancer Staging Manual
...
* subsites.hypopharynxSubsite ^comment = """AJCC 8th Edition Cancer Staging Manual
...
"""				
* subsites.oropharynxSubsite ^comment = """https://link.springer.com/book/9783319406176
...
* subsites.larynxSubsite ^comment = """AJCC 8th Edition Cancer Staging Manual
...
"""				
* subsites.oralCavitySubsite ^comment = """AJCC 8th Edition Cancer Staging Manual
...
Overlapping lesion of other and unspecified parts of mouth - """				
* subsites.lipSubsite ^comment = """AJCC 8th Edition Cancer Staging Manual
...
* subsites.upperAndLowerLimbsSubsite ^comment = """Hand 
Wrist 
Forearm
...
* subsites.breastSubsite ^comment = """Breast
