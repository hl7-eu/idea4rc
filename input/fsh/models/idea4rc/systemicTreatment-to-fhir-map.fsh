...
* group[=].element[=].target.comment = "The kind of treatment is also determined by the type of FHIR resource used.
MedicationAdministration is used for Chemotherapy orfor any administration of substances to a patient"					
