...
* group[=].element[+].code = #DiseaseExtent.episodeEvent
...
* group[=].element[=].target.comment = "Use extension value."
* group[=].element[+].code = #DiseaseExtent.regionalNodalMetastases
...
* group[=].element[+].code = #DiseaseExtent.sites.softTissue
* group[=].element[=].display = "Soft tissue (R)"
* group[=].element[=].target.code = #Condition.bodySite
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "Where code=4338971 'soft tissue'"
* group[=].element[+].code = #DiseaseExtent.sites.distantLymphNode
...
* group[=].element[+].code = #DiseaseExtent.locoRegional
...
* group[=].element[+].code = #DiseaseExtent.isTransitMetastasisWithClinicalConfirmation
...
* group[=].element[+].code = #DiseaseExtent.isMultifocalTumor
...
* group[=].element[+].code = #DiseaseExtent.localised
...
* group[=].element[+].code = #DiseaseExtent.numberOfTumorNodules
