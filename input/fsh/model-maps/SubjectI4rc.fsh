...
* comorbidity.congestiveHeartFailure 0..* boolean "Congestive heart failure (O)" """Previous cancer comorbidity related to Congestive heart failure (O)"""
* comorbidity.congestiveHeartFailure insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.peripheralVascularDisease 0..* boolean "Peripheral vascular disease (O)" """Previous cancer comorbidity related to Peripheral vascular disease (O)"""
* comorbidity.peripheralVascularDisease insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.cerebrovascularAccidentExceptHemiplegia 0..* boolean "Cerebrovascular accident  (except hemiplegia) (O)" """Previous cancer comorbidity related to Cerebrovascular accident  (except hemiplegia) (O)"""
* comorbidity.cerebrovascularAccidentExceptHemiplegia insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.dementia 0..* boolean "Dementia (O)" """Previous cancer comorbidity related to Dementia (O)"""
* comorbidity.dementia insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.chronicPulmonaryDisease 0..* boolean "Chronic pulmonary disease (O)" """Previous cancer comorbidity related to Chronic pulmonary disease (O)"""
* comorbidity.chronicPulmonaryDisease insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.connectiveTissueDisease 0..* boolean "Connective tissue disease (O)" """Previous cancer comorbidity related to Connective tissue disease (O)"""
* comorbidity.connectiveTissueDisease insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.ulcer 0..* boolean "Ulcer (O)" """Previous cancer comorbidity related to Ulcer (O)"""
* comorbidity.ulcer insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.mildLiverDisease 0..* boolean "Mild liver disease (O)" """Previous cancer comorbidity related to Mild liver disease (O)"""
* comorbidity.mildLiverDisease insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.moderateToSevereLiverDisease 0..* boolean "Moderate to severe liver disease (O)" """Previous cancer comorbidity related to Moderate to severe liver disease (O)"""
* comorbidity.moderateToSevereLiverDisease insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.diabetes 0..* boolean "Diabetes (without complications) (O)" """Previous cancer comorbidity related to Diabetes (without complications) (O)"""
* comorbidity.diabetes insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.diabetesWithEndOrganDamage 0..* boolean "Diabetes with end organ damage (O)" """Previous cancer comorbidity related to Diabetes with end organ damage (O)"""
* comorbidity.diabetesWithEndOrganDamage insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.hemiplegia 0..* boolean "Hemiplegia (O)" """Previous cancer comorbidity related to Hemiplegia (O)"""
* comorbidity.hemiplegia insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.moderateToSevereRenalDisease 0..* boolean "Moderate to severe renal disease (O)" """Previous cancer comorbidity related to Moderate to severe renal disease (O)"""
* comorbidity.moderateToSevereRenalDisease insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.solidTumor 0..* boolean "Solid tumor (non metastatic) (O)" """Previous cancer comorbidity related to Solid tumor (non metastatic) (O)"""
* comorbidity.solidTumor insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.metastaticSolidTumor 0..* boolean "Metastatic solid tumor (O)" """Previous cancer comorbidity related to Metastatic solid tumor (O)"""
* comorbidity.metastaticSolidTumor insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.leukemia 0..* boolean "Leukemia (O)" """Previous cancer comorbidity related to Leukemia (O)"""
* comorbidity.leukemia insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.lymphoma 0..* boolean "Lymphoma (O)" """Previous cancer comorbidity related to Lymphoma (O)"""
* comorbidity.lymphoma insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.multipleMyeloma 0..* boolean "Multiple myeloma (O)" """Previous cancer comorbidity related to Multiple myeloma (O)"""
* comorbidity.multipleMyeloma insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* comorbidity.aids 0..* boolean "AIDS (O)" """Previous cancer comorbidity related to AIDS (O)"""
