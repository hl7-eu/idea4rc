...
* group[=].element[+].code = #DrugsForTreatments.RegionalDeepHyperthemiaReference
* group[=].element[=].display = "RegionalDeepHyperthemia (M)"
* group[=].element[=].target.code = #Procedure
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #DrugsForTreatments.isolatedLimbPerfusionReference
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "Use type Substance and element code."
