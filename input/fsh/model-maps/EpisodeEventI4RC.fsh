...
* cancerEpisodeReference 1..* CancerEpisode "Cancer Episode Reference (M)" """CancerEpisode element containing the data regarding the patient's cancer"""
* cancerEpisodeReference insert ObligationActorAndCode($actor-headneck, #SHALL:handle)
* cancerEpisodeReference insert ObligationActorAndCode($actor-sarcoma-i4rc, #SHALL:handle)
