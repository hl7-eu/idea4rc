...
* group[=].element[+].code = #Surgery.surgicalSpecimenGradingOnlyInUntreatedTumours
...
* group[=].element[+].code = #Surgery.diagnosisReference
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #Surgery.surgeryType
...
* group[=].element[=].target.code = #Procedure.extension:ProcedureCategoryR5.value[x]
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use type CodeableConcept"
* group[=].element[+].code = #Surgery.typeOfSurgicalApproachOnTumour
* group[=].element[=].display = "Type of surgical approach on Tumour (M)"
* group[=].element[=].target.code = #Procedure.extension:ProcedureMethod.value[x]
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use type CodeableConcept"
...
* group[=].element[+].code = #Surgery.dateOfNeckSurgery
...
* group[=].element[=].target.code = #Procedure.bodySite.extension:qualifier
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[+].code = #Surgery.extraNodalExtension
...
* group[=].element[+].code = #Surgery.surgicalSpecimenMitoticCount
