...
* group[=].element[+].code = #Diagnosis.typeOfBiopsy
* group[=].element[=].display = "Type of biopsy (M)"
* group[=].element[=].target.code = #Condition.evidence:diagnosisDetails.detail
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "See details in group2"
* group[=].element[+].code = #Diagnosis.biopsyDoneBy
* group[=].element[=].display = "Biopsy done by (M)"
* group[=].element[=].target.code = #Condition.evidence:diagnosisDetails.detail
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "See details in group2"
* group[=].element[+].code = #Diagnosis.ageAtDiagnosis
* group[=].element[=].display = "Age at diagnosis (M)"
* group[=].element[=].target.code = #Condition.onset[x]
* group[=].element[=].target.dependsOn.property = "datatype"
* group[=].element[=].target.dependsOn.value = "Age"
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[+].code = #Diagnosis.radiotherapyInducedSarcoma
...
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "See details in group2"
* group[=].element[+].code = #Diagnosis.tumorSize
* group[=].element[=].display = "Tumor Size (M)"
* group[=].element[=].target.code = #Condition.evidence:simpleResult.detail
* group[=].element[=].target.dependsOn.property = "datatype"
* group[=].element[=].target.dependsOn.value = "Quantity"
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueQuantity; Where detail.resolve().ofType(Observation).code is $athena#36768664"
* group[=].element[+].code = #Diagnosis.superficialDepth
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueQuantity; Where detail.resolve().ofType(Observation).code is $athena#36768749"
* group[=].element[+].code = #Diagnosis.deepDepth
...
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueQuantity; Where detail.resolve().ofType(Observation).code is $athena#36768749"
* group[=].element[+].code = #Diagnosis.biopsyMitoticCount
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueQuantity; Where detail.resolve().ofType(Observation).code is $athena#4227243"
* group[=].element[+].code = #Diagnosis.mitoticIndex
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueCodeableConcept; Where detail.resolve().ofType(Observation).code is $athena#4099595"
* group[=].element[+].code = #Diagnosis.plasmaticEbvDnaAtBaseline
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueCodeableConcept; Where detail.resolve().ofType(Observation).code is $athena#3043849"
* group[=].element[+].code = #Diagnosis.hpvStatus
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueCodeableConcept; Where detail.resolve().ofType(Observation).code is $athena#46236082"
* group[=].element[+].code = #Diagnosis.crpTested
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[=].target.comment = "Use Observation.valueCodeableConcept; Where detail.resolve().ofType(Observation).code is $athena#3000965"
* group[+].source = "http://hl7.eu/fhir/ig/idea4rc/StructureDefinition/Diagnosis"
