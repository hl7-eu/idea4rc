...
* evidence[diagnosisDetails].detail = Reference(observation-id-21)
// * evidence[+].code = $athena#36768664 "Dimension of Tumor"
* evidence[simpleResult][+].detail = Reference(observation-id-31)
//* evidence[+].code = $athena#4227243 "Number of mitoses per 10 high power fields"
* evidence[simpleResult][+].detail = Reference(observation-id-32)
...
* evidence[simpleResult][+].detail = Reference(observation-id-33)
...
* evidence[simpleResult][+].detail = Reference(observation-id-34)
// * evidence[+].code = $athena#3000965 "C reactive protein [Presence] in Serum or Plasma"
* evidence[simpleResult][+].detail = Reference(observation-id-35)
