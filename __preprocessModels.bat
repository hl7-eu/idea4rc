...
@REM CALL :buildFshFiles input\fsh\models\surg
@REM CALL :buildFshFiles input\fsh\models\sct
@REM CALL :buildFshFiles input\fsh\models\flt
@REM CALL :buildFshFiles input\fsh\models\relapseFlt
@REM CALL :buildFshFiles input\fsh\models\other
@REM REM CALL :buildFshFiles input\fsh\models\suggestion
@REM CALL :buildFshFiles input\fsh\models\relapseAfterFlt


@REM REM CALL :buildFshFiles input\fsh\models\minChemio
@REM REM CALL :addItems
...
@REM  REM fart -C input\fsh\immunization.fsh  "* differential.element[8].type.code = #http://iso.org/fhir/ts-5384/StructureDefinition/Subject" "* differential.element[8].type[0].code = #http://iso.org/fhir/ts-5384/StructureDefinition/Subject \n* differential.element[8].type[1].code = #http://iso.org/fhir/ts-5384/StructureDefinition/Subject-uc1"
 
@REM  REM fart -C input\fsh\immunization.fsh   "* differential.element[28].type.code = #http://iso.org/fhir/ts-5384/StructureDefinition/Forecast" "* differential.element[28].type[0].code = #http://iso.org/fhir/ts-5384/StructureDefinition/Forecast \n* differential.element[28].type[1].code = #http://iso.org/fhir/ts-5384/StructureDefinition/Forecast-uc1"
 
@REM  REM fart -C input\fsh\immunization.fsh "* differential.element[9].type.code = #http://iso.org/fhir/ts-5384/StructureDefinition/Product" "* differential.element[9].type[0].code = #http://iso.org/fhir/ts-5384/StructureDefinition/Product \n* differential.element[9].type[1].code = #http://iso.org/fhir/ts-5384/StructureDefinition/Product-uc1"
